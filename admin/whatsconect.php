...
<html lang="pt-br">
  <head>
    ...
    $dominioserver = 'whatsapi.wrssh.online';
    ...
    $("#backuppainel").click(function() {
        ...
        if (isset($_POST['salvartokenapi'])) {
          ...
          if (mysqli_num_rows($result) > 0) {
              // Se j existe um registro, atualize-o
...
if (window.innerWidth < 678) {
    ...
    document.write('<div class="alert alert-warning" role="alert"> <strong>Atenço!</strong> Mova para lado para Fazer Alguma Aço! </div>');
...
$(document).ready(function() {
    // Captura o evento de clique no botão de edião
    ...
    // Chamar a funço inicialmente
    exibirOcultarHora();

    // Chamar a função sempre que a opço for alterada
        ...
        <form action="whatsconect.php" method="POST">
                                      ...
                                      <script>
                                        ...
                                        const mensagens = {
                                          ...
                                          '🕟 Limite: {limite} <br><br>\n\n' +
                                          '🌍Link de Renovaão: https://{dominio}/renovar.php\n' +
                                          'Esse link  servirá para você fazer as suas renovações',
