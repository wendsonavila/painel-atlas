  ...
  $result1 = $conn->query($sql1);
    ...
    if ($ssh_accounts == null) {
        ...
        foreach ($ssh_accounts as $ssh_account) {
            ...
            fwrite($file, $login . " " . $uuid . PHP_EOL);
       }
    }
...
if ($sucess == true) {
   echo "1";
    ...
    echo "<script>sweetAlert('Sucesso!', 'Contas suspensas com sucesso!', 'success').then(function() {window.location.href = 'listarrevendedores.php';});</script>";    
}else{
    echo "erro";
    echo "<script>swal('Erro!', 'Erro ao suspender as contas!', 'error').then(function() {window.location.href = 'listarrevendedores.php';});</script>";    
}
$loop->run();
unlink($nome);
