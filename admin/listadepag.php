...
if (window.innerWidth < 678) {
            ...
            $(this).remove(); 
                        ...
                        <div class="card-content">
                          ...
                          if($user_data['status'] == 'Aprovado'){
                            ...
                            $cancel = "<button type='button' class='btn btn-danger' onclick='cancelar(".$user_data['idpagamento'].")'>Cancelar</button>";
                            }
    ...
    function cancelar(id){
        swal({
            title: "Tem certeza?",
            text: "Se o Pagamento for cancelado, você não poderá mais recuperá-lo!",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
